...
var AllHours = [
    new HourItem(8.00, 9.30),
    new HourItem(9.50, 11.20),
    new HourItem(11.30, 13.00),
    new HourItem(14.00, 15.30),
    new HourItem(15.45, 17.15),
    new HourItem(17.30, 19.00),
]
...
function FindCurrentHourIndex(d, Day) {
    ...
    if (CurrentTime < 19.00 && CurrentTime > 8.00) {
        return -2;
    }
    //No more school
    return -1;
